...
public class fSapXepPhimTheoGia extends JFrame {

	private JPanel contentPane;
	
	public fSapXepPhimTheoGia() throws ClassNotFoundException, IOException {
		...
		for (Phim p : Rap.sapXepGiaPhim(rap.getDsPhim())) {
	...
	public static void main() throws ClassNotFoundException, IOException {
		fSapXepPhimTheoGia ds= new fSapXepPhimTheoGia();
