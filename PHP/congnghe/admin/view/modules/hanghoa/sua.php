<?php
	...
	$model = new Model();
	foreach($model->getGoodsList() as $goods)
...
<form action="view/modules/hanghoa/xuly.php?stt=<? echo $goods["stt"] ?>&trang=<? echo $_GET["trang"] ?>" method="post" enctype="multipart/form-data" class="col-lg-5 col-md-12 col-sm-12 col-xs-12"> 
	<div>
        <table width="100%" border="0">
          <tr>
            <td colspan="3"><div align="center"><strong>SỬA SẢN PHẨM</strong></div></td>
          </tr>
          <tr height="40px">
            <td width="80px"></td>
            <td><?
          ...
          <tr height="40px">
            <td>Tên máy</td>
            <td colspan="2"><input type="text" name="ten" id="ten" value="<? echo $goods["ten"] ?>" style="width:100%"></td>
          </tr>
          <tr height="40px">
            <td>Giá</td>
            <td colspan="2">
