...
public class aXemDSHoiVien extends JFrame {

	private JPanel contentPane;
	
	public aXemDSHoiVien() throws ClassNotFoundException, IOException {
		setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
		setTitle("Danh sách hội viên");
		...
		for (HoiVien p : rap.getDsHoiVien()) {
	...
	public static void main() throws ClassNotFoundException, IOException {
		aXemDSHoiVien ds= new aXemDSHoiVien();
