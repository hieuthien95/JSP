...
<form action="/BaiVietServlet?command=insert" method="POST" class="workplace"
		...
		<div class="span12">
			...
			<div class="block-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span9" style="padding: 15px">
						...
						<div class="block-fluid" id="wysiwyg_container">
							...
							<textarea id="wysiwyg" name=noidung style="height: 300px;"></textarea>
				...
				<div class="row-form">
					...
					<div class="span9">
						<textarea name="tomtat" placeholder="Tóm tắt..."></textarea>
					</div>
					<div class="clear"></div>
				</div>
				...
				<div class="row-form">
					<div class="span3"></div>
					<div class="span9">
						<input class="btn" type="submit" value="Thêm bài viết">
					</div>
					<div class="clear"></div>
				</div>
