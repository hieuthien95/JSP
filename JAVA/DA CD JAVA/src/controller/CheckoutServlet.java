...
public class CheckoutServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		case "insert":
			...
			session.setAttribute("error", "Thêm đơn hàng thành công. Hãy thanh toán");
			break;
		case "update":
			...
			new DonHangDAO().update(new DonHang(order_code, 0, "", "", payment_id, new Timestamp(new Date().getTime()) + " "));
			...
			session.setAttribute("success", "Đã thanh toán");
			return;
		}
