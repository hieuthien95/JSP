...
public class eDSPhimDoanhThuCao extends JFrame {

	private JPanel contentPane;
	
	public eDSPhimDoanhThuCao() throws ClassNotFoundException, IOException {
		setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
		setTitle("Doanh thu phim");
		...
		for (Phim p : rap.sapXepDoanhThuPhim()) {
	...
	public static void main() throws ClassNotFoundException, IOException {
		eDSPhimDoanhThuCao ds= new eDSPhimDoanhThuCao();
