...
public class eDSPhimHanhDong extends JFrame {

	private JPanel contentPane;
	
	public eDSPhimHanhDong() throws ClassNotFoundException, IOException {
		setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
		setTitle("Phim hành động");
		...
		for (Phim p : rap.layDSPhimHanhDong()) {
	...
	public static void main() throws ClassNotFoundException, IOException {
		eDSPhimHanhDong ds= new eDSPhimHanhDong();
		ds.setBounds(400, 150, 900, 250);
		ds.setVisible(true);
	}
}