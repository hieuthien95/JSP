                ...
                <div class="col-md-8 col-sm-9 wow fadeInRight">
                        ...
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    <img src="upload/thanhtoan/VISA.png" alt="" />
                                </div>
                    ...
                    <div class="col-sm-3">
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    <img src="upload/thanhtoan/JCB.png" alt="" />
                                </div>
                                <div class="overlay-icon">
                                    <i class="glyphicon glyphicon-ok-circle"></i>
                                </div>
                    ...
                    <div class="col-sm-2">
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    <img src="upload/thanhtoan/MASTER.png" alt="" />
                                </div>
                                <div class="overlay-icon">
                                    <i class="glyphicon glyphicon-ok-circle"></i>
                                </div>
                    ...
                    <div class="col-sm-2">
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    <img src="upload/thanhtoan/PayPal.png" alt="" />
                                </div>
                                <div class="overlay-icon">
                                    <i class="glyphicon glyphicon-ok-circle"></i>
                                </div>
                    ...
                    <div class="col-sm-2">
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    <img src="upload/thanhtoan/MOL.png" alt="" />
                                </div>
                                <div class="overlay-icon">
                                    <i class="glyphicon glyphicon-ok-circle"></i>
                                </div>
            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="single-widget">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li><a
                                href="tim-kiem/{{$lsp->ten}}">{{$lsp->ten}}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="single-widget">
                        <h2>Tin tức</h2>
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="news-list">Tin tức, bài viết</a></li>
                            <li><a href="video-list">Video</a></li>
                            <li><a href="km-list">Tin khuyến mãi</a></li>
                            <li><a href="td-list">Tuyển dụng</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-2">
